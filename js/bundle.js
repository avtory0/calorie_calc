  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      statusMessage.style.cssText = `
          ...
          margin: 0 auto;
       `;
      form.insertAdjacentElement('afterend', statusMessage); // insertAdjacentElement позволяет более гибко вставить эл-т; 1 прмтр - после какого элта вставлять, 2 - что именно
      // const request = new XMLHttpRequest(); //-- старый способ
      // request.open('POST', 'server.php');

      const formData = new FormData(form);
      const json = JSON.stringify(Object.fromEntries(formData.entries())); //entries - превращает в массивов массивов
...
/* harmony import */ var _modules_calc__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_calc__WEBPACK_IMPORTED_MODULE_5__);
...
window.addEventListener('DOMContentLoaded', () => {
  const modelTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.OpenModal)('.modal', modelTimerId), 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.default)('[data-modal]', '.modal', modelTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-07-13');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__.default)();
  _modules_calc__WEBPACK_IMPORTED_MODULE_5___default()();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)('form', modelTimerId);
